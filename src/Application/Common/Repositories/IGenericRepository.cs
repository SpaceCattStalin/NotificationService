...
namespace Application.Common.Interfaces.Repositories
{
    ...
    public interface IGenericRepository<T> where T : class
    {
        ...
        /// <summary>
        /// Returns the first entity matching the condition or null if not found.
        /// </summary>
        /// <param name="predicate">The condition to filter records.</param>
        /// <returns>The first entity matching the condition, or null.</returns>
        T? FirstOrDefault(Expression<Func<T, bool>> predicate);

        /// <summary>
        /// Returns the first entity matching the condition or null if not found, asynchronously.
        /// </summary>
        /// <param name="predicate">The condition to filter records.</param>
        /// <returns>A task with the first entity matching the condition, or null.</returns>
